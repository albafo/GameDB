...
public class VistaApp extends JFrame {
	...
	public VistaApp() {
		...
		/* Inicializamos las ventanas (JPanel) de nuestra aplicación */
		...
		/* Insertamos en el contendor las ventanas de nuestra aplicación */
		
		contenedorVentanas.add(vistaPrincipal);
